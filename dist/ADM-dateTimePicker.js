...
(function(angular) {
    ...
    var ADMdtpDirective = function(ADMdtp, ADMdtpConvertor, ADMdtpFactory, constants, $compile, $timeout) {
        ...
        return {
            ...
            template: '<div class="ADMdtp-container" ng-class="{rtl: (calType==\'jalali\'), touch: option.isDeviceTouch, disable: disable}">' +
            '<div class="clickOutContainer" click-out="closeCalendar()">' +
            '<ng-transclude></ng-transclude> ' +
            '<div ng-if="defaultTemplate" class="" ng-class="{touch: option.isDeviceTouch, disable: disable, open: showCalendarStat}">' +
            '<div layout="row" layout-align="center center">' +
            '<input placeholder="{{option.placeholder}}"  ng-model="dtpValue.formated" ng-focus="openCalendar()" ng-disabled="option.freezeInput || option.isDeviceTouch || disable" ng-blur="modelChanged()">' +
            '</div>' +
            '</div>'
        };
    }
